...
describe("saveMatchResult", () => {
  ...
  it("returns error when update fails (line 95)", async () => {
    ...
    mockSupabaseFrom.mockReturnValueOnce(
      createQueryMock({ data: { id: "match-1", completed: false }, error: null })
    );
    // update fails
    mockSupabaseFrom.mockReturnValueOnce(
  ...
  it("returns error when match is already completed", async () => {
    ...
    mockSupabaseFrom.mockReturnValueOnce(
      createQueryMock({ data: { id: "match-1", completed: true }, error: null })
    );
...
describe("generateNextPhase", () => {
  ...
  it("returns error when semis not complete for 4-team (semi→final path)", async () => {
    ...
    const semiMatches = [
      { id: "s1", phase: "semi", home_team_id: "t1", away_team_id: "t4", home_score: null, away_score: null, match_order: 1, completed: false },
      { id: "s2", phase: "semi", home_team_id: "t2", away_team_id: "t3", home_score: null, away_score: null, match_order: 2, completed: false },
    ];
    mockSupabaseFrom.mockReturnValueOnce(
  ...
  it("returns error when final already generated for 4-team tournament", async () => {
    ...
    const semiMatches = [
      { id: "s1", phase: "semi", home_team_id: "t1", away_team_id: "t4", home_score: 2, away_score: 1, match_order: 1, completed: true },
      { id: "s2", phase: "semi", home_team_id: "t2", away_team_id: "t3", home_score: 1, away_score: 0, match_order: 2, completed: true },
    ];
    const finalMatch = [
      { id: "f1", phase: "final", home_team_id: "t1", away_team_id: "t2", home_score: null, away_score: null, match_order: 1, completed: false },
    ];
    mockSupabaseFrom.mockReturnValueOnce(
      createQueryMock({ data: [...groupMatches, ...semiMatches, ...finalMatch], error: null })
    );
  ...
  it("generates final for 4-team tournament after semis are complete", async () => {
    ...
    const semiMatches = [
      { id: "s1", phase: "semi", home_team_id: "t1", away_team_id: "t4", home_score: 2, away_score: 1, match_order: 1, completed: true },
      { id: "s2", phase: "semi", home_team_id: "t2", away_team_id: "t3", home_score: 0, away_score: 1, match_order: 2, completed: true },
    ];
    mockSupabaseFrom.mockReturnValueOnce(
      createQueryMock({ data: [...groupMatches, ...semiMatches], error: null })
    );
  ...
  it("generates final when away team wins semi1 (line 242)", async () => {
    ...
    const semiMatches = [
      ...
      { id: "s1", phase: "semi", home_team_id: "t1", away_team_id: "t4", home_score: 0, away_score: 2, match_order: 1, completed: true },
  ...
  it("uses ?? 0 fallback when semi scores are null (lines 240, 245)", async () => {
    ...
    const semiMatches = [
      ...
      { id: "s1", phase: "semi", home_team_id: "t1", away_team_id: "t4", home_score: null, away_score: null, match_order: 1, completed: true },
      { id: "s2", phase: "semi", home_team_id: "t2", away_team_id: "t3", home_score: null, away_score: null, match_order: 2, completed: true },
    ];
    mockSupabaseFrom.mockReturnValueOnce(
      createQueryMock({ data: [...groupMatches, ...semiMatches], error: null })
    );
  ...
  it("generates final when home team wins semi2 (line 246)", async () => {
    ...
    const semiMatches = [
      ...
      { id: "s2", phase: "semi", home_team_id: "t2", away_team_id: "t3", home_score: 2, away_score: 0, match_order: 2, completed: true },
    ];
    mockSupabaseFrom.mockReturnValueOnce(
      createQueryMock({ data: [...groupMatches, ...semiMatches], error: null })
    );
  ...
  it("returns error when group not complete for 5-team tournament (line 182)", async () => {
    ...
    mockSupabaseFrom.mockReturnValueOnce(
      createQueryMock({
        data: [
          { id: "m1", phase: "group", home_team_id: "t1", away_team_id: "t2", home_score: null, away_score: null, match_order: 1, completed: false },
        ],
        error: null,
      })
    );
