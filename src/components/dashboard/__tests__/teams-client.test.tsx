...
const TEAMS = [
  {
    ...
    teamNumber: 1,
    players: [
      { gameTeamPlayerId: "gtp1", playerId: "p1", name: "Carlos", isStar: true, goals: 2, assists: 1 },
      { gameTeamPlayerId: "gtp2", playerId: "p2", name: "Bruno", isStar: false, goals: 0, assists: 0 },
    ],
  },
  {
    id: "gt2",
    teamNumber: 2,
    players: [
      { gameTeamPlayerId: "gtp3", playerId: "p3", name: "André", isStar: false, goals: 1, assists: 0 },
    ],
  },
];
...
describe("TeamsClient", () => {
  ...
  describe("team rendering", () => {
    ...
    it("shows read-only message when game is finished", () => {
      ...
      expect(
        screen.getByText(/somente leitura/i)
      ).toBeInTheDocument();
    });
  });
