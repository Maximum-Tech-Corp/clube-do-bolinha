...
describe("PlayersListClient", () => {
  describe("empty states", () => {
    ...
    it("shows search-empty message when search has no results", async () => {
      ...
      await user.type(screen.getByPlaceholderText("Buscar por nome..."), "XYZXYZ");
  ...
  describe("search / filter", () => {
    ...
    it("search is case-insensitive", async () => {
      ...
      await user.type(screen.getByPlaceholderText("Buscar por nome..."), "BRUNO");
    ...
    it("partial name match works", async () => {
      ...
      await user.type(screen.getByPlaceholderText("Buscar por nome..."), "Lima");
