...
describe("BottomNav (dashboard)", () => {
  describe("rendering", () => {
    it("renders all 5 nav links", () => {
      ...
      expect(screen.getByRole("link", { name: /jogadores/i })).toBeInTheDocument();
    ...
    it("renders correct hrefs", () => {
      ...
      expect(screen.getByRole("link", { name: /jogos/i })).toHaveAttribute("href", "/dashboard/jogos");
      expect(screen.getByRole("link", { name: /jogadores/i })).toHaveAttribute("href", "/dashboard/jogadores");
      expect(screen.getByRole("link", { name: /histórico/i })).toHaveAttribute("href", "/dashboard/historico");
      expect(screen.getByRole("link", { name: /rankings/i })).toHaveAttribute("href", "/dashboard/rankings");
    });
  });
